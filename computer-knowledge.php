...
<html lang="en">
    ...
    <div class="container-fluid">
            ...
            <div class="col-md-3">
                <div class="mcq-list bg-success mt-4">
                    ...
                    <div class="list-group">
                        <a href="analitical.php" class="list-group-item list-group-item-action">
                            Analitical
                        </a>
                        <a href="computer-knowledge.php" class="list-group-item list-group-item-action active bg-warning">Computer Knowledge</a>
		...
		<script type="text/javascript" src="js/computer-knowledge.js"></script>
	</body>
</html>